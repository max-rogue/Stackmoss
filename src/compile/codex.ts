...
This file is \`AGENTS.md\` for Codex.
...
- Claude Code bootstrap: \`CLAUDE.md\` and \`.claude/rules/\`
- Cursor bootstrap: \`.cursor/rules/\`
- VS Code / Copilot bootstrap: \`.github/copilot-instructions.md\`
- Antigravity bootstrap: \`.agents/skills/\`
